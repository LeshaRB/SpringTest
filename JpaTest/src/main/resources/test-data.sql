...
insert into contact (first_name, last_name, birth_date) values ('Lesha', 'Labotsky', '1986-04-11');
...
insert into contact_tel_detail (contact_id, tel_type, tel_number) values (4, 'Moble', '+375297744443');
...
insert into contact_hobby_detail(contact_id, hobby_id) values (4, 'Programming'); 